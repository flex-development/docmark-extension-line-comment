...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-shell
   cd docmark-extension-shell
   ```
...
```sh
https://github.com/flex-development/docmark-extension-shell/compare/main...$branch
```
